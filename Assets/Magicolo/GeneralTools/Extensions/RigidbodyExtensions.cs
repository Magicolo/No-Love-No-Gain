...
namespace Magicolo {
	public static class RigidbodyExtensions {
		...
		public static void OscillateVelocity(this Rigidbody rigidbody, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axes = Axes.XYZ) {
			rigidbody.SetVelocity(rigidbody.velocity.Oscillate(frequency, amplitude, center, rigidbody.GetInstanceID() / 1000, axes), axes);
		}

		public static void OscillateVelocity(this Rigidbody rigidbody, Vector3 frequency, Vector3 amplitude, Axes axes = Axes.XYZ) {
			OscillateVelocity(rigidbody, frequency, amplitude, Vector3.zero, axes);
		}
		
		public static void OscillateVelocity(this Rigidbody rigidbody, float frequency, float amplitude, Axes axes = Axes.XYZ) {
			OscillateVelocity(rigidbody, new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), Vector3.zero, axes);
		}
		
		public static void OscillateVelocity(this Rigidbody rigidbody, float frequency, float amplitude, float center, Axes axes = Axes.XYZ) {
			OscillateVelocity(rigidbody, new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), new Vector3(center, center, center), axes);
		}
		#endregion
		...
		public static void OscillatePosition(this Rigidbody rigidbody, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axes = Axes.XYZ) {
			rigidbody.SetPosition(rigidbody.transform.position.Oscillate(frequency, amplitude, center, rigidbody.GetInstanceID() / 1000, axes), axes);
		}
		
		public static void OscillatePosition(this Rigidbody rigidbody, Vector3 frequency, Vector3 amplitude, Axes axes = Axes.XYZ) {
			rigidbody.OscillatePosition(frequency, amplitude, Vector3.zero, axes);
		}

		public static void OscillatePosition(this Rigidbody rigidbody, float frequency, float amplitude, float center, Axes axes = Axes.XYZ) {
			rigidbody.OscillatePosition(new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), new Vector3(center, center, center), axes);
		}
		
		public static void OscillatePosition(this Rigidbody rigidbody, float frequency, float amplitude, Axes axes = Axes.XYZ) {
			rigidbody.OscillatePosition(new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), Vector3.zero, axes);
		}
		#endregion
		...
		public static void OscillateEulerAngles(this Rigidbody rigidbody, Vector3 frequency, Vector3 amplitude, Vector3 center, Axes axes = Axes.XYZ) {
			rigidbody.SetEulerAngles(rigidbody.transform.eulerAngles.Oscillate(frequency, amplitude, center, rigidbody.GetInstanceID() / 1000, axes), axes);
		}
		
		public static void OscillateEulerAngles(this Rigidbody rigidbody, Vector3 frequency, Vector3 amplitude, Axes axes = Axes.XYZ) {
			rigidbody.OscillateEulerAngles(frequency, amplitude, Vector3.zero, axes);
		}

		public static void OscillateEulerAngles(this Rigidbody rigidbody, float frequency, float amplitude, float center, Axes axes = Axes.XYZ) {
			rigidbody.OscillateEulerAngles(new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), new Vector3(center, center, center), axes);
		}
		
		public static void OscillateEulerAngles(this Rigidbody rigidbody, float frequency, float amplitude, Axes axes = Axes.XYZ) {
			rigidbody.OscillateEulerAngles(new Vector3(frequency, frequency, frequency), new Vector3(amplitude, amplitude, amplitude), Vector3.zero, axes);
		}
		#endregion
	}
}
