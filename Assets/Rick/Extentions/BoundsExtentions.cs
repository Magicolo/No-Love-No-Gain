using UnityEngine;using System.Collections;using Magicolo;using Rick;public static class BoundsExtentions{	public static Vector2 TopLeft(this Bounds bounds)
	{
