...
namespace Magicolo {
	public static class Rigidbody2DExtension {
		...
		public static void AccelerateTowards(this Rigidbody2D rigidbody, Vector2 targetAcceleration, float speed, InterpolationModes interpolation, Axes axes = Axes.XY) {
		...
		public static void AccelerateTowards(this Rigidbody2D rigidbody, Vector2 targetAcceleration, float speed, Axes axes = Axes.XY) {
			rigidbody.AccelerateTowards(targetAcceleration, speed, InterpolationModes.Quadratic, axes);
		}
		
		public static void AccelerateTowards(this Rigidbody2D rigidbody, float targetAcceleration, float speed, InterpolationModes interpolation, Axes axes = Axes.XY) {
			rigidbody.AccelerateTowards(new Vector2(targetAcceleration, targetAcceleration), speed, interpolation, axes);
		}
		
		public static void AccelerateTowards(this Rigidbody2D rigidbody, float targetAcceleration, float speed, Axes axes = Axes.XY) {
			rigidbody.AccelerateTowards(new Vector2(targetAcceleration, targetAcceleration), speed, InterpolationModes.Quadratic, axes);
		}
